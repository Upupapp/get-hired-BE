...
const config={ownerConnectionId:process.env.REFERRAL_BUNNY_OWNER_CONNECTION_ID,ownerProgramId:process.env.REFERRAL_BUNNY_OWNER_PROGRAM_ID,enabled:true,paymentsEnabled:true,refundsEnabled:process.env.REFERRAL_BUNNY_REFUNDS_ENABLED==='true',clientSecret:process.env.REFERRAL_BUNNY_CLIENT_SECRET,encryptionKey:process.env.REFERRAL_BUNNY_ENCRYPTION_KEY,rbOrigin:process.env.REFERRAL_BUNNY_ORIGIN||'https://referralbunny.ai'};
